// main.js — Scroll reveal, sumário ativo, reset e relatório — Circuitos Elétricos
// Mesma máquina dos EDs de Dinâmica, com o banco de questões deste estudo.
...
(function () {
  ...
  // ================================================================
  const TOPIC_NAMES = {
    quiz1: 'Tópico 01 — O que é um circuito',
  ...
  function initReport() {
    ...
    if (downloadBtn) {
      downloadBtn.addEventListener('click', function () {
        ...
        a.href = url;
        a.download = 'relatorio_circuitos_' + new Date().toISOString().slice(0, 10) + '.txt';
    ...
    if (emailBtn) {
      emailBtn.addEventListener('click', function () {
        const subject = encodeURIComponent('Relatório de Estudo — Circuitos Elétricos');
