// =====================================================
// CONFIGURAÇÃO — mesmo projeto Supabase da prova de MRU,
// porém com tabelas próprias desta prova (evita colisão
// de gabarito, já que ambas usam q1..q20 como chave).
// =====================================================
...
const TABELA_GABARITO = 'gabarito_cinematica';
const TABELA_RESPOSTAS = 'respostas_cinematica';
...
document.getElementById('btn-submit').addEventListener('click', async function () {
  ...
  try {
    const gabarito = await supabaseFetch(`${TABELA_GABARITO}?select=questao,resposta_correta`, 'GET');
    const gabMap = {};
    ...
    await supabaseFetch(TABELA_RESPOSTAS, 'POST', {
      id: respostaId,
    ...
    await supabaseFetch(TABELA_RESULTADOS, 'POST', {
