// main.js — Scroll reveal, sumário ativo, reset e relatório — Energia Potencial e Conservação
...
(function () {
  ...
  // ================================================================
  const TOPIC_NAMES = {
    quiz4:      'Tópico 01 — Energia Potencial Gravitacional',
    quizEpe:    'Tópico 02 — Energia Potencial Elástica',
    quizEm:     'Tópico 03 — Energia Mecânica',
    quizConserv:'Tópico 04 — Conservação da Energia Mecânica',
    quiz7:      'Tópico 05 — Exemplos de Conservação de Energia',
    quizDissip: 'Tópico 06 — Energia Térmica e Dissipação',
  };
  ...
  function initReport() {
    ...
    if (downloadBtn) {
      downloadBtn.addEventListener('click', function () {
        ...
        a.href = url;
        a.download = 'relatorio_energia_potencial_conservacao_' + new Date().toISOString().slice(0, 10) + '.txt';
    ...
    if (emailBtn) {
      emailBtn.addEventListener('click', function () {
        const subject = encodeURIComponent('Relatório de Estudo — Energia Potencial e Conservação');
