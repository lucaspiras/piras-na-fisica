// main.js — Scroll reveal, sumário ativo, reset e relatório — Trabalho e Energia Cinética
...
(function () {
  ...
  const TOPIC_NAMES = {
    ...
    quiz8:  'Tópico 02 — Unidades de Energia',
    quiz2:  'Tópico 03 — Trabalho de uma Força',
    quiz2b: 'Tópico 04 — Trabalho com Várias Forças',
    quiz3:  'Tópico 05 — Energia Cinética',
    quizT:  'Tópico 06 — Teorema Trabalho-Energia Cinética',
    quiz9:  'Tópico 07 — Potência',
  };
  ...
  function initReport() {
    ...
    if (downloadBtn) {
      downloadBtn.addEventListener('click', function () {
        ...
        a.href = url;
        a.download = 'relatorio_trabalho_energia_cinetica_' + new Date().toISOString().slice(0, 10) + '.txt';
    ...
    if (emailBtn) {
      emailBtn.addEventListener('click', function () {
        const subject = encodeURIComponent('Relatório de Estudo — Trabalho e Energia Cinética');
